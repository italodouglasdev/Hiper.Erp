...
namespace Hiper.Erp.Aplicacao.Validadores.FormasPagamentos
{
    public class DtoFormaPagamentoValidador
    {
        public static ResultadoOperacao<bool> Cadastrar(DtoFormaPagamento dto)
        {
        ...
        public static ResultadoOperacao<bool> Atualizar(DtoFormaPagamento dto)
        {
            var resultado = new ResultadoOperacao<bool>();
            var validador = new ResultadoValidacao<bool>();
