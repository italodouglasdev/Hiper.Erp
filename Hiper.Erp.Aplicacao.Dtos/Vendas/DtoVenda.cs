...
namespace Hiper.Erp.Aplicacao.Dtos.Vendas
{
    public class DtoVenda
    {
        ...
        [ParametrosDeTabela(NomeColuna = "Código da Forma de Pagamento", ExibirColuna = false, ExibirFiltros = false)]
        ...
        [ParametrosDeTabela(NomeColuna = "Código do Cliente", ExibirColuna = false, ExibirFiltros = false)]
